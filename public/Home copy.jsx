...
function Home() {
  ...
  return (
    <section id="home" className="flex gap-2 w-full h-screen bg-white/5 justify-end items-center">
        ...
        <div className="flex lg:flex-col lg:w-1/2 lg:h-full justify-center items-end font-poppins gap-2">
            ...
            <div className="flex flex-col gap-2 text-center w-full p-2">
                ...
                <p className="text-7xl font-bold text-black/85">Sanjith</p>
            ...
            <div className="flex flex-row gap-3 font-medium justify-center p-2">
                <button className="rounded-3xl border-solid border-2 border-slate-200 text-sm font-normal text-black/85 px-4 py-3 hover:bg-zinc-800/85 hover:text-white/85 transition-all duration-500">Download CV</button>
