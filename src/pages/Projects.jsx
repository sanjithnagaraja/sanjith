     ...
     <div className="flex flex-wrap gap-10 w-full justify-center p-10 pt-28 ">
        ...
        {projects.map((project, index) => (
          <div key={index} className="lg:w-[400px] h-auto rounded-2xl border-2 border-solid border-textBase/25 p-7 flex flex-col space-y-5">
            ...
            <p className="text-sm text-textBase/65 mt-2 text-justify">{project.links.note}</p>
            :
            <p className="text-sm text-textBase/85 mt-2 text-justify">{project.links.note}</p>}
          </div>
        ))}
      {/* Fullscreen overlay */}
      {fullscreenImg && (
